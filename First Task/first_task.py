...
def main():
    ...
    parser.add_argument("path", nargs="?", help="Directory path to monitor")
    parser.add_argument("--update", action="store_true", help="Update hash record after checking")
    args = parser.parse_args()

    # If no path provided via CLI, ask interactively
    if not args.path:
        args.path = input("📥 Enter the directory path to monitor: ").strip()
